/* ============================================================
   Legal Oversight Room — synthetic engagement pathway SVG
   ------------------------------------------------------------
   Click-to-expand detail panels for the inline SVG pathway diagram.
   Synthetic engagement model (R&D Simulation Ltd).
...
(function () {
  var PHASE_DETAILS = {
    A: {
      ...
      description: 'The engagement roadmap, commercial proposal, and Legal & Audit pack are released to this workspace. the counterparty routes the partnership internally and the engagement record is opened. Ailane prepares the mutual NDA template against the proposal\'s confidentiality covering terms.',
      activities: [
        'Roadmap and proposal review by the counterparty',
        'Internal routing acknowledgement by the counterparty',
    ...
    B: {
      ...
      description: 'A mutual non-disclosure agreement is executed between Ailane and R&D Simulation Ltd. The Pilot Statement of Work is scoped against the per-package data field schedule. NDA execution unlocks subsequent document releases in this workspace.',
      activities: [
