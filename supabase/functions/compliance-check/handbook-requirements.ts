// HANDBOOK REQUIREMENT LIBRARY — 38 requirements
// Canonical source: AILANE-CC-BRIEF-HBCHECK-001 §3
// Do NOT paraphrase, summarise, or abbreviate.
...
export const HANDBOOK_REQUIREMENTS: HandbookRequirement[] = [
  ...
  // DOMAIN 4: LEAVE ENTITLEMENTS (5 requirements)
  {
    id: 'HB-14',
  ...
  // DOMAIN 5: DATA PROTECTION & PRIVACY (3 requirements)
  {
    id: 'HB-19',
  ...
  // DOMAIN 4 CONTINUED: ADDITIONAL LEAVE (3 requirements)
  {
    id: 'HB-34',
    domain: 'Leave Entitlements',
  ...
  // DOMAIN 5 CONTINUED: REMOTE WORKING
  {
    id: 'HB-37',
    domain: 'Data Protection & Privacy',
