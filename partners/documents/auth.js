 ...
 *
 * AMD-145 §3.1 canonical 7-state taxonomy: gate_state values are phase_0 /
 * phase_a / phase_b / phase_c / phase_d / phase_e / phase_f. Read directly;
 * no client-side translation. (Supersedes AMD-106 v5 6-state taxonomy.)
 * ============================================================================= */
...
(function() {
  ...
  // Canonical 7-state taxonomy per AMD-145 §3.1. Higher rank = later phase.
  const PHASE_RANK = {
    phase_0: 0,
    phase_a: 1,
    phase_b: 2,
